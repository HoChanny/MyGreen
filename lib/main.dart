...
import 'package:mygreen/home.dart';
...
Future<void> main() async {
  ...
  final dataController = Get.put(GlobalState());
  //If subscribe based sent notification then use this token
  final fcmToken = await messaging.getToken();
  print(fcmToken);
  dataController.setDeviceToken(fcmToken.toString());
  print('this! ${dataController.deviceToken}');
